...
// Можно превратить весь код в немедленно вызываемую функцию - Immediately Invoked Function Expression (IIFE). 
// Это позволит изолировать код на случай необходимости расположения других элементов на странице.
...
var OBSTACLE_INTERVAL = 5000; // Интервал между возникновением препятствий
var snake = []; // Сама змейка
var direction = 'y+'; // Направление движения змейки
var gameIsRunning = false; // Запущена ли игра
var snake_timer; // Таймер змейки
var food_timer; // Таймер для еды
var obstacle_timer; // Таймер для препятствия
...
function startGame() {
    ...
    obstacle_timer = setInterval(createObstacle, OBSTACLE_INTERVAL);
